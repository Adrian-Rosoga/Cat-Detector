...
call .\run_cat_detector.bat --model "%CAT_DETECTOR_MODEL%" video --tapo-ip 192.168.1.111 --tapo-username "%TAPO_USERNAME%" --tapo-password "%TAPO_PASSWORD%" --tapo-profile main --display --beep-cooldown 1.5 --telegram-send --telegram-config telegram-send.conf %*
